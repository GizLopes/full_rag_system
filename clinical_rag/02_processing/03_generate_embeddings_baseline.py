# OBJETIVO PRINCIPAL
# Gerar embeddings Titan para chunks baseline por tokens, salvando JSONL local e no S3 para comparação inicial do RAG
...
DEFAULT_CHUNKS_KEY = "chunks/clinical_chunks.jsonl"
DEFAULT_OUTPUT_KEY = "embeddings/clinical_embeddings.jsonl"
DEFAULT_OUTPUT_FILE = "clinical_embeddings.jsonl"
...
SCRIPT_DESCRIPTION = "Gera embeddings Titan para os chunks baseline do RAG clínico."
